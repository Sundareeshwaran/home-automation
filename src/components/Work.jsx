  ...
  return (
    <div className="mt-24 px-4 md:px-8 lg:px-16" id="howitswork">
      ...
      <div className="flex flex-col items-center text-3xl md:text-4xl lg:text-5xl">
        ...
        <h3 className="font-abyssinica text-lg md:text-2xl lg:text-3xl w-full md:w-[600px] text-center">
      ...
      {[
        ...
        <div key={index} className="flex justify-center my-12 md:my-20">
          <div className="flex flex-col items-center gap-4 md:gap-10">
            <h1 className="bg-leather-50 px-6 md:px-8 py-3 md:py-4 md:w-full max-w-[450px] text-center rounded-lg text-sherpa-blue-950 text-lg md:text-2xl">
              {step.title}
            </h1>
            <div className="relative w-full max-w-[90%] md:max-w-[757px]">
              <img
